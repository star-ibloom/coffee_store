...
/***/function (module, exports, __webpack_require__) {
  ...
  var homeOrderTpl = __webpack_require__(141);

  var indexController = __webpack_require__(19);
  var orderController = __webpack_require__(142);
...
/***/function (module, exports, __webpack_require__) {
  ...
  var orderModel = __webpack_require__(143);
  ...
  module.exports = {
    ...
    renderFirstLevel: function renderFirstLevel() {
      ...
      orderModel.getFirstLevel().then(function (resultFir) {
        ...
        _this.renderSecondLevel({ type: 0 });
        _this.renderSecondLevel({ type: 1 });
        _this.renderSecondLevel({ type: 2 });
      });
    },
...
/***/function (module, exports) {
  ...
  module.exports = {
    ...
    getDrinks: function getDrinks(data) {
      return $.ajax({
        url: '/api/prod/drinks',
        type: "get",
        data: data,
    ...
    getGourmet: function getGourmet(data) {
      return $.ajax({
    ...
    getperipheral: function getperipheral(data) {
      return $.ajax({
