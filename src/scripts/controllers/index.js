const indexController = {
    headerAction() {
      const pagelist = ['home.html','myOrder.html', 'changeTable.html','login.html', 'welcome.html']
      ...
      switch(location.pathname.substr(1)){
        ...
        case  "myOrder.html" : $('header li').eq(1).addClass("active");break;
        case  "changeTable.html" : $('header li').eq(2).addClass("active");break;
