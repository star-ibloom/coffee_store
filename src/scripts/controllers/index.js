const indexController = {
    headerAction() {
      const pagelist = ['home.html','order.html','myOrder.html', 'changeTable.html','login.html', 'welcome.html']
      ...
      switch(location.pathname.substr(1)){
        ...
        case  "login.html" : $('header li').eq(4).addClass("active");break;
        case  "welcome.html" : $('header li').eq(5).addClass("active");break;
        default:return;
      }
    }
  }
